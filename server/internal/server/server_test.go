...
func TestServer_preflight(t *testing.T) {
	...
	for _, origin := range []string{
		"http://localhost",
		"https://app.staging.cloudnatix.com",
		"https://app.cloudnatix.com",
		"https://app.staging.cloudnatix.com:443",
	} {
...
func TestServer_preflightNotAllowed(t *testing.T) {
	...
	for _, origin := range []string{
		"http://app.staging.cloudnatix.com",
		"https://example.com",
		"",
		"....",
	} {
...
func (p *fakeProxy) Proxy(w http.ResponseWriter, r *http.Request) int {
	p.gotWriter = w
	p.gotReq = r
	return 0
}
...
func (mp *mockProducer) TxnStatus() sarama.ProducerTxnStatusFlag {
	return sarama.ProducerTxnFlagInitializing
}
